...
function deleteWarning(handle) {
  ...
  $(".warning-class").html(
    '<span class="warning-code">' +
      code +
      '</span> ( <span class="warning-section">' +
      section +
      "</span> ) " +
      ' , <span class="warning-year">' +
      year +
      "</span>"
  );
}
...
function addTheClass() {
  ...
  $.ajax({
    ...
    success: function (r) {
      ...
      $(".wrapper").prepend(
        '<div class="class"> <a class="no-decoration" href="take.php?cN=' +
          r.class_id +
          '"> <div><strong>Code</strong> : <span class="code">' +
          r.code +
          '</span></div> <div><strong>Section</strong> : <span class="section">' +
          r.section +
          '</span></div> <div><strong>Year</strong> : <span class="year">' +
          r.year +
          "</span> </div> <div><strong>Classes</strong> : 0</div> </div></a>"
      );
